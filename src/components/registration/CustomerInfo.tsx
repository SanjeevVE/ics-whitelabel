...
const CustomerInfo: React.FC<CustomerInfoProps> = ({
  ...
  // Optional: Add coupon validation effect
  useEffect(() => {
    ...
    <div className="w-full">
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Address Section */}
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-medium mb-4 border-b pb-2 mt-4">Address Information</h3>
          </div>
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-medium mb-4 border-b pb-2 mt-4">Emergency Contact</h3>
          </div>
          ...
          <div>
            ...
            />
            {formik.touched.emergencyContactName && formik.errors.emergencyContactName && (
              <p className="mt-1 text-sm text-red-500">{formik.errors.emergencyContactName}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {formik.touched.emergencyContactNumber && formik.errors.emergencyContactNumber && (
              <p className="mt-1 text-sm text-red-500">{formik.errors.emergencyContactNumber}</p>
            )}
          </div>

          {/* Additional Information Section */}
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-medium mb-4 border-b pb-2 mt-4">Additional Information</h3>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                ...
                {formik.touched.termsAndConditions && formik.errors.termsAndConditions && (
                  <p className="mt-1 text-sm text-red-500">{formik.errors.termsAndConditions}</p>
                )}
              </div>
            </div>
          </div>
